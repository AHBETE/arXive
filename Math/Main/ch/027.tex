\section{插曲: 距离, 范数, 和内积 - 选读}\label{027}
...
提到了距离元, 忍不住提一下体积元, 【\ref{021}\nameref{021}】中有稍稍带过一下体元
...
(关于偏微分, 参见【\ref{023}\nameref{023}】, 关于三维以下的行列式计算,
参见【\ref{026}\nameref{026}】叉乘部分的讨论, 关于行列式通常的运算, 参见本节末末【附录】.),
更高维 (更多变量) 的情况并不难推广.
